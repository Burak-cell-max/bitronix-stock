...
class _ProductDetailScreenState extends ConsumerState<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final movementsAsync =
        ref.watch(movementsByProductProvider(_product.id));
                ...
                children: [
                  ...
                  _InfoCard(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          _product.sku.isNotEmpty ? _product.sku : _product.id,
            ...
            children: [
              Text(statusLabel,
                  style: TextStyle(
                      ...
                      fontSize: 13)),
              Text('Mevcut Stok: ${product.stock} ${product.unit}',
                  style: const TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.bold)),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(movement.type.displayLabel,
                    style: const TextStyle(
...
class _QuickAdjustPanel extends StatefulWidget {
  const _QuickAdjustPanel({required this.product});
  final Product product;

  @override
  State<_QuickAdjustPanel> createState() => _QuickAdjustPanelState();
}

class _QuickAdjustPanelState extends State<_QuickAdjustPanel> {
  bool _isBusy = false;
          ...
          Wrap(
            ...
            children: [
              for (final n in [1, 5, 10, 50])
                _AdjBtn('+$n', const Color(0xFF10B981), _isBusy,
                    () => _adjust(n)),
              for (final n in [1, 5, 10, 50])
                _AdjBtn('-$n', const Color(0xFFEF4444), _isBusy,
                    () => _adjust(-n)),
            ],
          ),
        ],
