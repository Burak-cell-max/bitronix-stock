...
class _StockCountScreenState extends ConsumerState<StockCountScreen> {
  ...
  Future<void> _applyCount() async {
    ...
    try {
      await StockRepository(FirebaseFirestore.instance).applyStockCount(
        items: _items,
          ...
          children: [
            ...
            productsAsync.when(
              ...
              data: (products) => ElevatedButton.icon(
                ...
                label: const Text('Sayımı Başlat',
                    style: TextStyle(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 1,
            child: Text('${item.product.stock} ${item.product.unit}',
                style: const TextStyle(
